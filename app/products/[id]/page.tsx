...
const products = [
  {
    ...
    description: "Premium wireless headphones with active noise cancellation and exceptional sound quality. Perfect for music lovers and professionals alike.",
    features: [
  ...
  },
  {
    ...
    description: "Durable and stylish laptop backpack with multiple compartments and ergonomic design. Perfect for work and travel.",
    features: [
  ...
  },
  {
    ...
    category: "Home",
    description: "Programmable coffee maker with thermal carafe and built-in grinder. Wake up to fresh coffee every morning.",
    features: [
      "Built-in grinder",
      "Programmable timer",
      "12-cup capacity",
